...
![Tests](https://github.com/ara-5/Money-Threat-intel/actions/workflows/tests.yml/badge.svg)
![Daily Run](https://github.com/ara-5/Money-Threat-intel/actions/workflows/threat_intel.yml/badge.svg)
...
*`docs/` is generated by the pipeline at runtime and committed by GitHub Actions.*
...
https://ara-5.github.io/Money-Threat-intel/latest.json

# Specific date
https://ara-5.github.io/Money-Threat-intel/report_2025-06-01.json
```
